...
{
    protected $table = 'panduan_documents';
    ...
    protected $validationMessages = [
        'title' => [
            'required' => 'Judul panduan harus diisi',
            'max_length' => 'Judul panduan terlalu panjang'
        ],
        'status' => [
    ...
    /**
     * Get all active guides ordered by sort_order
     */
     ...
     * Update sort order
     */
    public function updateSortOrder($guideId, $sortOrder)
    {
        return $this->update($guideId, ['sort_order' => $sortOrder]);
    }
