            ...
            <div class="col-md-12 col-lg-10">
                <div class="d-flex align-items-center flex-wrap gap-4" style="padding: 2rem 0;">
                    ...
                    <div style="color: white;">
                        <h1 style="font-size: 3rem; font-weight: 700; margin-bottom: 0.5rem; text-shadow: 1px 1px 3px rgba(70, 67, 67, 0.3); font-family: 'Poppins', sans-serif; color: #ecececff;">
    Selamat datang di InlisLite V3
</h1>

                        <p style="font-size: 1.20rem; line-height: 1.6; max-width: 750px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2); font-family: 'Poppins', sans-serif;">
