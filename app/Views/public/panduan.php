...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?= base_url('assets/css/public/panduan.css') ?>" rel="stylesheet">
</head>
<body>
    <!-- Top Navigation -->
    <nav class="top-nav sticky-top">
        <div class="container-fluid">
            <div class="nav-content">
                <div class="nav-left">
                    <a href="<?= base_url('/') ?>" class="back-btn" title="Kembali ke Beranda">
                ...
                <div class="card documentation-card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-1">Dokumentasi Tersedia (6)</h5>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="resources-list">
                            <li>
                                ...
                                <a href="<?= base_url('aplikasi') ?>" class="resource-link">Installer > Platform PHP</a>
                            </li>
                            <li>
                                <i class="bi bi-arrow-up-circle me-2"></i>
                                <span>Panduan update sistem dapat ditemukan di </span>
                                <a href="<?= base_url('patch') ?>" class="resource-link">Patch & Updater > Platform PHP</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Custom JavaScript -->
    <script src="<?= base_url('assets/js/public/panduan.js') ?>"></script>
</body>
</html>