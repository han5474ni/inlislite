...
<head>
    ...
    <title>Demo Program - INLISLite v3.0</title>
        ...
        <div class="container">
            <div class="header-content">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="header-title mb-1">Demo Program</h1>
                        <p class="header-subtitle mb-0">Demonstrasi fitur sistem</p>
                    </div>
                    <div class="ms-auto">
                        <a href="<?= base_url('admin/demo-edit') ?>" class="btn btn-primary">
        ...
        <div class="container">
            ...
            <div class="banner-card mb-5">
                ...
                <div class="banner-content">
                    <h2 class="banner-title">Demo Program</h2>
                    <h3 class="banner-subtitle">INLISLite v3</h3>
                    <p class="banner-description">
                        Demo interaktif untuk memahami fitur-fitur sistem perpustakaan dan melihat cara kerja aplikasi secara langsung.
                    </p>
                </div>
            </div>
            ...
            <section class="content-section">
                <div class="section-header mb-4">
                    <h2 class="section-title">Konten Demo Program</h2>
                    <p class="section-subtitle">
                        Kelola dan atur konten Demo Program untuk memberikan informasi terbaik kepada pengguna
                    </p>
                </div>
