...
<head>
    ...
    <title>Panduan Pengguna - INLISLite v3.0</title>
        ...
        <div class="container">
            <div class="header-content">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="header-title mb-1">Panduan Pengguna</h1>
                        <p class="header-subtitle mb-0">Dokumentasi dan tutorial</p>
                    </div>
                    <div class="ms-auto">
                        <a href="<?= base_url('admin/panduan-edit') ?>" class="btn btn-primary">
        ...
        <div class="container">
            ...
            <div class="banner-card mb-5">
                ...
                <div class="banner-content">
                    <h2 class="banner-title">Panduan Pengguna</h2>
                    <h3 class="banner-subtitle">INLISLite v3</h3>
                    <p class="banner-description">
                        Dokumentasi lengkap dan panduan penggunaan sistem perpustakaan untuk membantu pengguna memaksimalkan fitur yang tersedia.
                    </p>
                </div>
            </div>
            ...
            <section class="content-section">
                <div class="section-header mb-4">
                    <h2 class="section-title">Konten Panduan Pengguna</h2>
                    <p class="section-subtitle">
                        Kelola dan atur konten Panduan Pengguna untuk memberikan informasi terbaik kepada pengguna
                    </p>
                </div>
