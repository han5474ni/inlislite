...
<head>
    ...
    <title>Dukungan Teknis - INLISLite v3.0</title>
        ...
        <div class="container">
            <div class="header-content">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="header-title mb-1">Dukungan Teknis</h1>
                        <p class="header-subtitle mb-0">Bantuan dan support sistem</p>
                    </div>
                    <div class="ms-auto">
                        <a href="<?= base_url('admin/dukungan-edit') ?>" class="btn btn-primary">
        ...
        <div class="container">
            ...
            <div class="banner-card mb-5">
                ...
                <div class="banner-content">
                    <h2 class="banner-title">Dukungan Teknis</h2>
                    <h3 class="banner-subtitle">INLISLite v3</h3>
                    <p class="banner-description">
                        Tim ahli siap membantu menyelesaikan masalah teknis dan memberikan dukungan untuk kelancaran operasional perpustakaan.
                    </p>
                </div>
            </div>
            ...
            <section class="content-section">
                <div class="section-header mb-4">
                    <h2 class="section-title">Konten Dukungan Teknis</h2>
                    <p class="section-subtitle">
                        Kelola dan atur konten Dukungan Teknis untuk memberikan informasi terbaik kepada pengguna
                    </p>
                </div>
