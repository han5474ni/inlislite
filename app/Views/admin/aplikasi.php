...
<head>
    ...
    <title>Aplikasi Pendukung - INLISLite v3.0</title>
        ...
        <div class="container">
            <div class="header-content">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="header-title mb-1">Aplikasi Pendukung</h1>
                        <p class="header-subtitle mb-0">Tools dan utilitas pendukung</p>
                    </div>
                    <div class="ms-auto">
                        <a href="<?= base_url('admin/aplikasi-edit') ?>" class="btn btn-primary">
        ...
        <div class="container">
            ...
            <div class="banner-card mb-5">
                ...
                <div class="banner-content">
                    <h2 class="banner-title">Aplikasi Pendukung</h2>
                    <h3 class="banner-subtitle">INLISLite v3</h3>
                    <p class="banner-description">
                        Koleksi aplikasi dan tools pendukung untuk meningkatkan produktivitas dan fungsionalitas sistem perpustakaan.
                    </p>
                </div>
            </div>
            ...
            <section class="content-section">
                <div class="section-header mb-4">
                    <h2 class="section-title">Konten Aplikasi Pendukung</h2>
                    <p class="section-subtitle">
                        Kelola dan atur konten Aplikasi Pendukung untuk memberikan informasi terbaik kepada pengguna
                    </p>
                </div>
