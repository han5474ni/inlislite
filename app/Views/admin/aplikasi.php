...
<head>
    ...
    <title><?= $title ?? 'Aplikasi Pendukung - INLISlite v3.0' ?></title>
                    ...
                    <div class="nav-content">
                        <div class="nav-left">
                            ...
                            <div class="logo-section">
                                ...
                                <div class="nav-text">
                                    <h1 class="nav-title">Aplikasi Pendukung</h1>
                                    <p class="nav-subtitle">Unduh dan instalasi tools pendukung</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="text-center mb-5">
                                    ...
                                    <h1 class="header-title">Aplikasi Pendukung INLISLite Versi 3 PHP Opensource</h1>
                                    <p class="header-subtitle">Kumpulan aplikasi dan tools pendukung untuk meningkatkan fungsionalitas sistem perpustakaan INLISLite v3 dengan berbagai modul terintegrasi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
