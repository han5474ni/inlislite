...
<head>
    ...
    <title><?= $title ?? 'Tentang INLISLite - INLISlite v3.0' ?></title>
                    ...
                    <div class="nav-content">
                        <div class="nav-left">
                            ...
                            <div class="logo-section">
                                ...
                                <div class="nav-text">
                                    <h1 class="nav-title">Tentang</h1>
                                    <p class="nav-subtitle">Informasi sistem perpustakaan</p>
                                </div>
                            </div>
                        </div>
                        <div class="nav-right">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="text-center mb-5">
                                    ...
                                    <h1 class="header-title">Tentang INLISLite Versi 3 PHP Opensource</h1>
                                    <p class="header-subtitle">Informasi lengkap tentang sistem otomasi perpustakaan modern dengan teknologi terdepan dan fitur-fitur canggih untuk mengelola perpustakaan secara digital.</p>
                                </div>
                            </div>
                        </div>
                    </div>
