/**
 * INLISLite v3.0 Patch & Updater Page
...
async function loadContent() {
    try {
        ...
        // Sample data for Patch & Updater
        const sampleContent = [
            {
                id: 1,
                title: "Sample Patch & Updater Item 1",
                subtitle: "Contoh item pertama",
                description: "Deskripsi lengkap untuk item pertama dalam kategori Patch & Updater. Item ini menunjukkan bagaimana konten ditampilkan dalam sistem.",
                category: "general",
                priority: "high"
            },
            {
                id: 2,
                title: "Sample Patch & Updater Item 2", 
            ...
            {
                id: 3,
                title: "Sample Patch & Updater Item 3",
                subtitle: "Contoh item ketiga",
                description: "Item ketiga ini menampilkan variasi konten yang dapat dikelola dalam sistem manajemen Patch & Updater.",
                category: "tutorial",
                priority: "low"
            }
        ];
