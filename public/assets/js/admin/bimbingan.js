/**
 * INLISLite v3.0 Bimbingan Teknis Page
...
async function loadContent() {
    try {
        ...
        // Sample data for Bimbingan Teknis
        const sampleContent = [
            {
                id: 1,
                title: "Sample Bimbingan Teknis Item 1",
                subtitle: "Contoh item pertama",
                description: "Deskripsi lengkap untuk item pertama dalam kategori Bimbingan Teknis. Item ini menunjukkan bagaimana konten ditampilkan dalam sistem.",
                category: "general",
                priority: "high"
            },
            {
                id: 2,
                title: "Sample Bimbingan Teknis Item 2", 
            ...
            {
                id: 3,
                title: "Sample Bimbingan Teknis Item 3",
                subtitle: "Contoh item ketiga",
                description: "Item ketiga ini menampilkan variasi konten yang dapat dikelola dalam sistem manajemen Bimbingan Teknis.",
                category: "tutorial",
                priority: "low"
            }
        ];
