/**
 * INLISLite v3.0 Aplikasi Pendukung Page
...
async function loadContent() {
    try {
        ...
        // Sample data for Aplikasi Pendukung
        const sampleContent = [
            {
                id: 1,
                title: "Sample Aplikasi Pendukung Item 1",
                subtitle: "Contoh item pertama",
                description: "Deskripsi lengkap untuk item pertama dalam kategori Aplikasi Pendukung. Item ini menunjukkan bagaimana konten ditampilkan dalam sistem.",
                category: "general",
                priority: "high"
            },
            {
                id: 2,
                title: "Sample Aplikasi Pendukung Item 2", 
            ...
            {
                id: 3,
                title: "Sample Aplikasi Pendukung Item 3",
                subtitle: "Contoh item ketiga",
                description: "Item ketiga ini menampilkan variasi konten yang dapat dikelola dalam sistem manajemen Aplikasi Pendukung.",
                category: "tutorial",
                priority: "low"
            }
        ];
